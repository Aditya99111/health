...
const backgroundImage = require('./images/cat.png');
...
const GamesScreen = () => {
  ...
  return (
    ...
    <SafeAreaView>
      ...
      >
        <Text style={{fontSize:25,fontWeight:500, color:"#fff"}}>Quiz for the day</Text>
        <Pressable
          style={{ paddingHorizontal: 15, backgroundColor: "#00a46c", borderRadius: 20,paddingVertical: 10 }}
        >
          <Text
